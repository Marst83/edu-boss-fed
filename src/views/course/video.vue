  ...
  <div class="container">
    <el-card>
      ...
      <el-form label-width="40px">
        ...
        <el-form-item v-if="showUploadFlag">
          <p>
            <span>视频上传中：{{ uploadPercent }}%</span>
            <span v-if="uploadPercent === 100">上传成功！</span>
          </p>
          <p v-if="uploadPercent === 100">
            <span>视频转码中：{{ aliyunTransCodePercent }}%</span>
            <span v-if="aliyunTransCodePercent === 100">转码成功！</span>
          </p>
        </el-form-item>
      </el-form>
    </el-card>
...
export default {
  ...
  created() {
    this.initUploader()
    console.log(this.sectionName, this.theme)
  },
  methods: {
    authUpload() {
      ...
      this.uploader = new window.AliyunUpload.Vod({
        ...
        onUploadEnd: async uploadInfo => {
          ...
          const timer = setInterval(async () => {
            ...
            this.aliyunTransCodePercent = data.data
            if (data.data === 100) {
